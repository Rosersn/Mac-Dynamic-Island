...
/// Bridges extension payload updates between Notchi processes (main app, helpers, XPC services).
...
final class ExtensionEventBridge {
    ...
    private func snapshotURL(for channel: Channel) -> URL {
        ...
        let directory = appSupport.appendingPathComponent("NotchiExtensions", isDirectory: true)
        switch channel {
        case .liveActivities:
